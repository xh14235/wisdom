      ...
      <div class="cmmmon-page" v-else>
        <transition name="fade" mode="out-in">
          <Anathird
            ...
            @changeSelect31="changeSelect31"
            @changeSelect32="changeSelect32"
          ></Anathird>
        </transition>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    add(index, nownum) {
      if (
        this.datafirst.abnormalEnergy[index].nownum <
        this.datafirst.abnormalEnergy[index].allnum
      ) {
        this.datafirst.abnormalEnergy[index].nownum++;
        this.getNewDetailBySeq(index, nownum);
      }
    ...
    anathird1() {
      ...
      anacompareday({
        ...
        this.datathird.echarts1 = {
          ...
          xData: date,
          data: [
            Object.values(ThisValue.ELECTRICITY).slice(0, date.length),
            Object.values(LastValue.ELECTRICITY).slice(0, date.length)
          ]
        };
        this.datathird.echarts2 = {
          ...
          xData: date,
          data: [
            Object.values(ThisValue.HOT_WATER).slice(0, date.length),
            Object.values(LastValue.HOT_WATER).slice(0, date.length)
          ]
        };
        this.datathird.echarts3 = {
          ...
          xData: date,
          data: [
            Object.values(ThisValue.COLD).slice(0, date.length),
            Object.values(LastValue.COLD).slice(0, date.length)
          ]
        };
        this.datathird.echarts4 = {
          ...
          xData: date,
          data: [
            Object.values(ThisValue.HOT).slice(0, date.length),
            Object.values(LastValue.HOT).slice(0, date.length)
          ]
        };
    ...
    anathird2() {
      ...
      if (this.compare1.ELECTRICITY && this.compare2.ELECTRICITY) {
        this.datathird.echarts5 = {
          ...
          yName: "(kWh)",
          data: [
            Object.values(this.compare1.ELECTRICITY).slice(0, date.length),
            Object.values(this.compare2.ELECTRICITY).slice(0, date.length)
          ]
        };
      }
      if (this.compare1.HOT_WATER && this.compare2.HOT_WATER) {
        this.datathird.echarts6 = {
          ...
          xData: date,
          data: [
            Object.values(this.compare1.HOT_WATER).slice(0, date.length),
            Object.values(this.compare2.HOT_WATER).slice(0, date.length)
          ]
        };
      }
      if (this.compare1.COLD && this.compare2.COLD) {
        this.datathird.echarts7 = {
          ...
          xData: date,
          data: [
            Object.values(this.compare1.COLD).slice(0, date.length),
            Object.values(this.compare2.COLD).slice(0, date.length)
          ]
        };
      }
      if (this.compare1.HOT && this.compare2.HOT) {
        this.datathird.echarts8 = {
          ...
          xData: date,
          data: [
            Object.values(this.compare1.HOT).slice(0, date.length),
            Object.values(this.compare2.HOT).slice(0, date.length)
          ]
        };
      }
    },
