      ...
      <div class="statistics-wrap">
        ...
        <div class="statistics-right">
          <div class="statistics-num">
            <span>{{
              parseInt(
                costList.UN_DIS_ELECTRICITY +
                  costList.DIS_ELECTRICITY +
                  costList.HOT_WATER +
                  costList.COLD +
                  costList.HOT
              ).toLocaleString()
      ...
      <div class="cost-list">
        <div class="cost-item">
          ...
          <div class="cost-num">
            <b>{{
              parseInt(
                costList.UN_DIS_ELECTRICITY + costList.DIS_ELECTRICITY
              ).toLocaleString()
            }}</b
            >元
          </div>
        ...
        <div class="cost-item">
          ...
          <div class="cost-num">
            <b>{{ parseInt(costList.HOT_WATER).toLocaleString() }}</b
            >元
          </div>
        </div>
        <div class="cost-item">
          ...
          <div class="cost-num">
            <b>{{ parseInt(costList.COLD).toLocaleString() }}</b
            >元
          </div>
        </div>
        <div class="cost-item">
          ...
          <div class="cost-num">
            <b>{{ parseInt(costList.HOT).toLocaleString() }}</b
            >元
          </div>
        </div>
      </div>
