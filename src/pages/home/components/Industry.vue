<template>
  <div class="industry-wrapper">
    ...
    <div class="common-echarts-wrapper">
      <div class="common-echarts-box">
        <div class="common-echarts-title">
          乡村会客厅
          <span
            >销售额总计：<b>{{ parseFloat(totle1).toLocaleString() }}</b
            >元</span
          >
        </div>
        <Eline
      ...
      <div class="common-echarts-box">
        <div class="common-echarts-title">
          玫瑰工坊
          <span
            >销售额总计：<b>{{ parseFloat(totle2).toLocaleString() }}</b
            >元</span
          >
        </div>
        <Eline
      ...
      <div class="common-echarts-box">
        <div class="common-echarts-title">
          合作社
          <span
            >销售额总计：<b>{{ parseFloat(totle3).toLocaleString() }}</b
            >元</span
          >
        </div>
        <Eline
      ...
      <div class="common-echarts-box">
        <div class="common-echarts-title">
          网红打卡点
          <span
            >销售额总计：<b>{{ parseFloat(totle4).toLocaleString() }}</b
            >元</span
          >
        </div>
        <Eline
    ...
    <div class="tab-wrapper">
      <div
        class="tab-box"
        :class="{ active: index === cooperativeTab }"
        v-for="(item, index) of cooperativeList"
        :key="item.id"
        @click="changeCooperative(item, index)"
      >
        {{ item.name }}
      </div>
    </div>
    <div class="common-echarts-wrapper">
      <div class="common-echarts-box">
        <div class="common-echarts-title">
          销售额
          <span
            >总计：<b>{{ parseFloat(total5).toLocaleString() }}</b
            >元</span
          >
        </div>
        <Eline
      ...
      <div class="common-echarts-box">
        <div class="common-echarts-title">
          订单数
          <span
            >总计：<b>{{ parseFloat(total6).toLocaleString() }}</b
            >个</span
          >
        </div>
        <Eline
