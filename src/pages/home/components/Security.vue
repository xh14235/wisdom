  ...
  <div class="monitor">
    ...
    <div class="distinguish-wrapper">
      <div class="distinguish-box">
        ...
        <div class="distinguish-list scroll" @click="showFacePopup()">
          <div
            class="distinguish-item face-item"
      ...
      <div class="distinguish-box">
        ...
        <div class="distinguish-list scroll" @click="showCarPopup()">
          <div
            class="distinguish-item car-item"
    ...
    <div class="common-table">
      ...
      <div class="table-body scroll">
        <p
          v-for="item of monitorList"
          :key="item.id"
          :class="{ active: item.status === 'UNPROCESSED' }"
        >
    ...
    <div class="number-wrapper">
      <div class="number-box">
        ...
        <div class="number-detail">
          ...
          <div class="number-right">
            <p>
              <img src="../../../assets/img/police.png" alt="" /><span
                >报警：</span
              ><b>{{ alarmTime.alarm }}</b>
            </p>
            <p>
              <img src="../../../assets/img/fire.png" alt="" /><span
                >火灾：</span
              ><b>{{ alarmTime.fire }}</b>
            </p>
          </div>
      ...
      <div class="number-box">
        ...
        <div class="number-detail">
          ...
          <div class="number-right">
            <p>
              <img src="../../../assets/img/local.png" alt="" /><span
                >本地：</span
              ><b>{{ peopleNum.local }}</b>
            </p>
            <p>
              <img src="../../../assets/img/shanghai.png" alt="" /><span
                >来沪：</span
              ><b>{{ peopleNum.outer }}</b>
            </p>
          </div>
