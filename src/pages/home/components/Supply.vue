  ...
  methods: {
    ...
    supHead2() {
      ...
      this.promise1 = new Promise((resolve, reject) => {
        supHead2({
          ...
          const data = res.data;
          let value = parseInt(
            data.CONCENTRATED_ENERGY_STORAGE +
              data.CONCENTRATED_WIND_POWER +
              data.CONCENTRATED_PHOTOVOLTAIC +
              data.ENERGY_CENTER
          );
    ...
    suphotwaterpie() {
      ...
      suphotwaterpie({
        ...
        const data = res.data;
        let value = parseInt(
          data.SOLAR_ENERGY + data.BIOMASS_CUBE + data.AIR_HEAT_PUMP
        );
    ...
    supcoldpie() {
      ...
      supcoldpie({
        ...
        const data = res.data;
        let value = parseInt(
          data.BURIED_PIPE + data.CHANNEL_THROWING + data.COOL_WATER_UNIT
        );
      ...
      this.promise2 = new Promise((resolve, reject) => {
        supSecond1({
          ...
          this.datasecond.echarts1 = {
            ...
            yName: "(kWh)",
            data: [
              Object.values(data.MIC_POWER_GRID_CUBE).slice(0, date.length)
            ]
          };
          this.datasecond.echarts2 = {
            ...
            yName: "(kWh)",
            data: [
              Object.values(data.CONCENTRATED_WIND_POWER).slice(0, date.length)
            ]
          };
          this.datasecond.echarts3 = {
            ...
            yName: "(kWh)",
            data: [
              Object.values(data.CONCENTRATED_PHOTOVOLTAIC).slice(
                0,
                date.length
              )
            ]
          ...
          this.datasecond.echarts4 = {
            ...
            yName: "(kWh)",
            data: [
              Object.values(data.CONCENTRATED_ENERGY_STORAGE).slice(
                0,
                date.length
              )
            ]
