  ...
  methods: {
    ...
    getRanking(id) {
      tripPerson({
        ...
        if (this.datafirst.ranking.length === 0) {
          this.datafirst.ranking = defaultList;
        }
      });
    },
    // 车位剩余情况
          ...
          if (data) {
            ...
            this.datasecond.echarts1 = {
              ...
              data: [
                ...
                {
                  value: CHARGE_PILE.total - CHARGE_PILE.usingCount,
                  name: "空闲中"
                }
              ],
            ...
            this.datasecond.echarts2 = {
              ...
              data: [
                ...
                {
                  value: ELECTRIC_CAR.total - ELECTRIC_CAR.usingCount,
                  name: "空闲中"
                }
              ],
            ...
            this.datasecond.echarts3 = {
              ...
              data: [
                ...
                {
                  value: ELECTRIC_BOAT.total - ELECTRIC_BOAT.usingCount,
                  name: "空闲中"
                }
              ],
            ...
            this.datasecond.echarts4 = {
              ...
              data: [
                ...
                {
                  value: ELECTRIC_BICYCLE.total - ELECTRIC_BICYCLE.usingCount,
                  name: "空闲中"
                }
              ],
